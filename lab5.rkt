#lang racket #| â˜… CSC324 Fall 2019: Lab 5 â˜… |#
#|
Module: lab5
Description: Lab 5: Macros, Macros, Macros
Copyright: (c) University of Toronto
               CSC324 Principles of Programming Languages, Fall 2019

Lab handout: https://www.cs.toronto.edu/~david/csc324/labs/lab5/handout.html.
|#
;-------------------------------------------------------------------------------
; â˜… Task 1: Macro practice â˜…
;-------------------------------------------------------------------------------
#|
(my-or p q) -> boolean?
  p: boolean?
...
(my-or* p ...) -> boolean?
  ...
  We've illustrated the basic pattern-match form below.
|#
(define-syntax my-or*
  (syntax-rules ()
    [(my-or*)
...
(my-cond [test-or-else then] ...)
  ...
  The built-in `cond` requires that `else` appear last; your macro does NOT need to
  enforce the same syntactic constraint.
...
;-------------------------------------------------------------------------------
; â˜… Task 2: Extending the `my-class` macro â˜…
;-------------------------------------------------------------------------------
...
(define-syntax my-class
  ...
  (syntax-rules (method constructor)
    [(my-class <class-name>
     ...
     (define (<class-name> <new-param> ...) (void))
     ]
